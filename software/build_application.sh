...
"$toolroot/gnu/microblaze/lin/bin/mb-gcc" -O2 -g -Wall -Wextra \
  ...
  software/application/*.c software/common/console.c software/common/settings.c software/common/bitcoin.c software/common/sha256_sw.c software/common/miner_protocol.c software/common/ina700.c \
